    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-indigo-50">
          {/* Progress Steps */}
          <div className="px-8 pt-8 pb-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-indigo-100">
            <div className="flex items-center justify-between max-w-2xl">
              ...
              <div className="flex-1 mx-4 h-0.5 bg-gradient-to-r from-blue-600 to-gray-300"></div>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-gray-500">Medical Details</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-gray-500">Appointment</span>
              </div>
            </div>
          </div>
