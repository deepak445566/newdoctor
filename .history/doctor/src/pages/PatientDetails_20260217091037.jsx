                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-xl">
                      ...
                      <span className="text-xl font-bold text-blue-600">₹{paymentSummary?.totalAmount || 0}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-xl">
                      <span className="text-sm font-medium text-gray-600">Paid Amount</span>
                      <span className="text-xl font-bold text-green-600">₹{paymentSummary?.paidAmount || 0}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-orange-50 rounded-xl">
                      <span className="text-sm font-medium text-gray-600">Rest Amount</span>
                      <span className="text-xl font-bold text-orange-600">₹{paymentSummary?.restAmount || 0}</span>
                    </div>
                    <div className="mt-4">
                      <button
