...
Kindly make sure to visit us on time. If you need to reschedule or have any questions, please feel free to contact us .
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div className="group relative bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div className="relative p-4 sm:p-5">
              <div className="flex items-center justify-between mb-2">
                <span className="text-2xl sm:text-3xl">⚡</span>
                <span className="text-xs font-medium text-amber-600 bg-amber-100 px-2 py-1 rounded-full">Quick</span>
              </div>
              <p className="text-sm font-semibold text-gray-900 mb-1 truncate">
                {upcomingPatients[0]?.name || 'No appointments'}
              </p>
              <p className="text-xs text-gray-500">Next patient</p>
            </div>
          </div>
        </div>
