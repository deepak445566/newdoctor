    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="relative">
                <div className="absolute inset-0 bg-blue-400 rounded-lg blur opacity-50 group-hover:opacity-75 transition animate-pulse"></div>
            ...
            <div className={`hidden md:flex items-center space-x-3 transition-all duration-500 transform ${showWelcome ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
              <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-1.5 rounded-full border border-blue-100">
                <span className="text-lg animate-wave">👋</span>
                <span className="text-sm text-gray-700">
                  {getGreeting()}, <span className="font-semibold text-blue-600">{admin?.email?.split('@')[0]}</span>
                </span>
              </div>
            </div>
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8">
          <div className="group relative bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div className="relative p-3 sm:p-4 md:p-5">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1">{upcomingPatients.length}</p>
          ...
          <div className="group relative bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div className="relative p-3 sm:p-4 md:p-5">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1">
                {upcomingPatients.filter(p => 
                  format(new Date(p.nextAppointmentDate), 'dd/MM/yyyy') === format(new Date(), 'dd/MM/yyyy')
                ).length}
              </p>
              <p className="text-xs text-gray-500">Today's appointments</p>
              <div className="mt-2 h-1 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-full w-1/2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full"></div>
              </div>
            </div>
          </div>
          ...
          <div className="group relative bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div className="relative p-3 sm:p-4 md:p-5">
              ...
              <div className="mt-2 h-1 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-full w-2/3 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full"></div>
              </div>
            </div>
          </div>

          <div className="group relative bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden col-span-2 lg:col-span-1">
            ...
            <div className="relative p-3 sm:p-4 md:p-5">
              <div className="flex items-center justify-between mb-2">
                <span className="text-2xl sm:text-3xl">⚡</span>
                <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-1 rounded-full">Quick</span>
              </div>
              <p className="text-xs sm:text-sm text-gray-600 mb-1">Next appointment</p>
              <p className="text-sm sm:text-base font-semibold text-gray-900 truncate">
                {upcomingPatients[0]?.name || 'No appointments'}
              </p>
              <div className="mt-2 flex items-center text-xs text-amber-600">
                <span className="mr-1">🚀</span>
                <Link to="/add-patient" className="hover:underline">Add new</Link>
              </div>
            </div>
          </div>
        </div>

        {/* Quick Actions - Unique Cards */}
        ...
        {/* Upcoming Appointments - Unique Timeline Design */}
        <div className="relative">
          {/* Section Header */}
          <div className="flex items-center justify-between mb-4 sm:mb-5">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-900">Upcoming Schedule</h2>
                <p className="text-xs text-gray-500">Next 10 days appointments</p>
              </div>
            </div>
            <Link 
              to="/all-patients" 
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl overflow-hidden border border-white/20">
            {loading ? (
              ...
              <div className="text-center py-8 sm:py-12">
                ...
                <p className="text-xs sm:text-sm text-gray-400 mt-1">No appointments in the next 10 days</p>
                <Link 
                  to="/add-patient" 
