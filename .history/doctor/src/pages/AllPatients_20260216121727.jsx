        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-3 sm:p-4">
            ...
            <div className="flex gap-2 mt-3 overflow-x-auto pb-2 scrollbar-hide">
              <span className="text-xs text-gray-500 whitespace-nowrap mr-1 hidden sm:block">Quick filters:</span>
              <button className="px-2 sm:px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-xs whitespace-nowrap hover:bg-blue-100 transition-colors">
                Today
              </button>
              <button className="px-2 sm:px-3 py-1 bg-green-50 text-green-600 rounded-full text-xs whitespace-nowrap hover:bg-green-100 transition-colors">
                This Week
              </button>
              <button className="px-2 sm:px-3 py-1 bg-purple-50 text-purple-600 rounded-full text-xs whitespace-nowrap hover:bg-purple-100 transition-colors">
                Follow-up
              </button>
              <button className="px-2 sm:px-3 py-1 bg-amber-50 text-amber-600 rounded-full text-xs whitespace-nowrap hover:bg-amber-100 transition-colors">
                New Patients
              </button>
            </div>
          </div>
