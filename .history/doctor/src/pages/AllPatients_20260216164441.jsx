...
const AllPatients = () => {
  ...
  const sendThankYouMessage = async (patient) => {
    try {
      const message = `Dear ${patient.name}, thank you for visiting our dental clinic. We appreciate your trust in us. Your registration number is ${patient.registrationNo}. For any questions, please contact us. Thanks & Regards, Dr. ${patient.doctorName}`;
