...
const AllPatients = () => {
  ...
  const sendThankYouMessage = async (patient) => {
    try {
      const message = `Dear ${patient.name}, thank you for visiting our dental clinic. We appreciate your trust in us. Your registration number is ${patient.registrationNo}. For any query, please contact us. Thanks & Regards, Dr. ${patient.doctorName} https://share.google/NA6nTqi4xdKEzdFJI`;
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <h1 className=" textlg:text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Patients
              </h1>
            </div>
