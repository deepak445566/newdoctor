  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-4 sm:py-6 md:py-8">
      <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        {/* Registration Number Preview Card */}
        <div className="mb-6 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
          <div className="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-xs text-purple-100">Registration Number (Auto-generated)</p>
            ...
            <div className="bg-white/20 px-3 py-1 rounded-full">
              <span className="text-xs text-white">10-digit unique ID</span>
            </div>
          </div>
          <div className="bg-white/10 px-4 sm:px-6 py-2">
            <p className="text-xs text-purple-200">
              ⚡ A unique 10-digit registration number will be automatically generated when you save
            </p>
          </div>
        </div>
