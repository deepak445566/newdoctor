...
const AllPatients = () => {
  ...
  }, [searchTerm, patients, currentPage, filterType]);
...
Thank you so much for visiting our dental clinic. We truly hope you're feeling better and more comfortable now.

💰 Payment Summary:
• Total Amount: ₹${patient.totalAmount || 0}
• Paid Amount: ₹${patient.paidAmount || 0}
• Pending Amount: ₹${patient.restAmount || 0}
