...
const PatientDetails = () => {
  ...
  const sendWhatsAppMessage = async (type) => {
    ...
    if (type === 'thankyou') {
      ...
      message = `Dear ${patient.name}, 🙏\n\nThank you for visiting our dental clinic today. We hope you're feeling better! Your oral health is our priority.\n\nFor any queries or concerns, please don't hesitate to contact us.\n\nBest regards,\nDr. ${patient.doctorName}`;
    } else if (type === 'reminder') {
      subject = 'Appointment Reminder';
      message = `Dear ${patient.name}, 📅\n\nThis is a friendly reminder for your dental appointment on ${format(new Date(patient.nextAppointmentDate), 'EEEE, dd MMMM yyyy')}. Please arrive 10 minutes early.\n\nWe look forward to seeing you!\n\nBest regards,\nDr. ${patient.doctorName}`;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <button className="p-2 bg-white rounded-xl shadow-sm hover:shadow-md transition-all text-gray-600 hover:text-blue-600">
